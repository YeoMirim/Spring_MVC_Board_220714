...
public class BDao {
	...
	public void reply(String bid, String bname, String btitle, String bcontent, String bgroup, String bstep, String bindent) {  // 원글의 값과 댓글의 값(bgroup, bstep, bindent)을 다 받아야함
